...
namespace Pensoft\ImageResize\ReportWidgets;
...
class ImageResizeClearWidget extends ReportWidgetBase
{
    public function defineProperties()
    {
        return [
            'showGcInterval' => [
                'title' => 'pensoft.imageresize::lang.widgets.clear.showGcInterval',
                'default' => true,
                'type' => 'checkbox',
            ]
        ];
    ...
    public function onClear()
    {
        ...
        Flash::success(Lang::get('pensoft.imageresize::lang.widgets.clear.cleared', [
            'size' => $size
        ]));
